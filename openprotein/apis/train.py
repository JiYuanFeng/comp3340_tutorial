...
from openprotein.core import DistEvalHook, DistOptimizerHook, EvalHook
from openprotein.datasets import build_dataloader, build_dataset
from openprotein.utils import (get_root_logger, wrap_distributed_model,
...
def train_model(model,
    ...
    Args:
        ...
        dataset (:obj:`openprotein.datasets.BaseDataset` | List[BaseDataset]):
