...
class CSPNet(BaseModule):
    ...
    Example:
        ...
        >>> import torch
        >>> import torch.nn as nn
        >>> from openprotein.models import CSPNet
        >>> from openprotein.models.backbones.resnet import Bottleneck
        >>>
...
class CSPDarkNet(CSPNet):
    ...
    Example:
        >>> from openprotein.models import CSPDarkNet
        >>> import torch
...
class CSPResNet(CSPNet):
    ...
    Args:
        ...
        init_cfg (dict or list[dict], optional): Initialization config dict.
            Default: None.
    Example:
        >>> from openprotein.models import CSPResNet
        >>> import torch
...
class CSPResNeXt(CSPResNet):
    ...
    Args:
        ...
        init_cfg (dict or list[dict], optional): Initialization config dict.
            Default: None.
    Example:
        >>> from openprotein.models import CSPResNeXt
        >>> import torch
