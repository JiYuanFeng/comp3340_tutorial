...
from openprotein.models.builder import BACKBONES
from openprotein.models.utils.attention import MultiheadAttention
from openprotein.models.utils.position_encoding import ConditionalPositionEncoding
...
class PCPVT(BaseModule):
    ...
    Examples:
        >>> from openprotein.models import PCPVT
        >>> import torch
...
class SVT(PCPVT):
    ...
    Examples:
        >>> from openprotein.models import SVT
        >>> import torch
        >>> svt_cfg = {'arch': "small",
        >>>            'norm_after_stage': [False, False, False, True]}
        >>> model = SVT(**svt_cfg)
